...
forecast_future <- function(run_name,PARAMETER_UNCERT,PROCESS_UNCERT,HOLD_CO2_PARAMETERS,HOLD_NONCO2_PARAMETERS,single_GCM,rcp = 85){
  ...
  for(s in 1:nsamples){
    ...
    if(HOLD_CO2_PARAMETERS == TRUE & PARAMETER_UNCERT == TRUE){
      new_pars[36] = median_pars[36]
      new_pars[47] = median_pars[47]
    }
    
    if(HOLD_NONCO2_PARAMETERS == TRUE & PARAMETER_UNCERT == TRUE){
      new_pars = median_pars
      curr_sample = sample(seq(1,length(accepted_pars_thinned_burned[,1])),1)
      new_pars[36] = accepted_pars_thinned_burned[curr_sample,36]
      new_pars[47] = accepted_pars_thinned_burned[curr_sample,47]
    }
...
nsamples = 500
forecast_future(run_name = 'par',PARAMETER_UNCERT=TRUE,PROCESS_UNCERT=FALSE,HOLD_CO2_PARAMETERS=FALSE,HOLD_NONCO2_PARAMETERS=FALSE,single_GCM=TRUE,rcp = 85)
forecast_future(run_name = 'par_co2hold',PARAMETER_UNCERT=TRUE,PROCESS_UNCERT=FALSE,HOLD_CO2_PARAMETERS=TRUE,HOLD_NONCO2_PARAMETERS=FALSE,single_GCM=TRUE,rcp = 85)
forecast_future(run_name = 'par_nonco2hold',PARAMETER_UNCERT=TRUE,PROCESS_UNCERT=FALSE,HOLD_CO2_PARAMETERS=FALSE,HOLD_NONCO2_PARAMETERS=TRUE,single_GCM=TRUE,rcp = 85)
forecast_future(run_name = 'process',PARAMETER_UNCERT=FALSE,PROCESS_UNCERT=TRUE,HOLD_CO2_PARAMETERS=FALSE,HOLD_NONCO2_PARAMETERS=FALSE,single_GCM=TRUE,rcp = 85)
forecast_future(run_name = 'climate85',PARAMETER_UNCERT=FALSE,PROCESS_UNCERT=FALSE,HOLD_CO2_PARAMETERS=FALSE,HOLD_NONCO2_PARAMETERS=FALSE,single_GCM=FALSE,rcp = 85)
forecast_future(run_name = 'climate45',PARAMETER_UNCERT=FALSE,PROCESS_UNCERT=FALSE,HOLD_CO2_PARAMETERS=FALSE,HOLD_NONCO2_PARAMETERS=FALSE,single_GCM=FALSE,rcp = 45)
forecast_future(run_name = 'par_process',PARAMETER_UNCERT=TRUE,PROCESS_UNCERT=TRUE,HOLD_CO2_PARAMETERS=FALSE,HOLD_NONCO2_PARAMETERS=FALSE,single_GCM=TRUE,rcp = 85)
forecast_future(run_name = 'par_climate',PARAMETER_UNCERT=TRUE,PROCESS_UNCERT=FALSE,HOLD_CO2_PARAMETERS=FALSE,HOLD_NONCO2_PARAMETERS=FALSE,single_GCM=FALSE,rcp = 85)
forecast_future(run_name = 'proc_climate',PARAMETER_UNCERT=FALSE,PROCESS_UNCERT=TRUE,HOLD_CO2_PARAMETERS=FALSE,HOLD_NONCO2_PARAMETERS=FALSE,single_GCM=FALSE,rcp = 85)
forecast_future(run_name = 'par_proc_climate',PARAMETER_UNCERT=TRUE,PROCESS_UNCERT=TRUE,HOLD_CO2_PARAMETERS=FALSE,HOLD_NONCO2_PARAMETERS=FALSE,single_GCM=FALSE,rcp = 85)