...
priormatrix[1,]  = c(.40,0.08,1.0,1,0,1) #pFS2 
...
priormatrix[5,]  = c(0.5,0.05,2.0,1,0,5) #pRx 
...
priormatrix[20,] = c(1.5,1.0,2.5,2,0,15)  #thinPower
...
priormatrix[24,] = c(.04,0.0167,0.0.42,1,0,17)  #Rttover  c(.04,0.0167,0.0417,1,0,17) 
priormatrix[25,] = c(0.20,0.15,0.35,1,0,18) #pCR for DUKE CAN BE m0  VAGUE 3PG PAPERS 
priormatrix[26,] = c(1.5,1.0,2.5,2,0,15) # AVIALABLE thinpower for DUKE CAN BE fN0 VAGUE 3PG PAPERS
...
priormatrix[32,] = c(3.54,0.2,4,1,0,24) #nAge
...
priormatrix[41,] = c(.02,0.005,0.07,1,0,32)  #alpha_h 
priormatrix[42,] = c(1.87,0.2,3.0,1,0,33) #pFS_h 
