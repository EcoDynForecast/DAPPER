...
priormatrix[19,] = c(250,100,400,1,0,14) #wSx1000 c(170,100,450,1,0) 3PGPAPERS
...
priormatrix[31,] = c(199,16,200,1,1,23)  #MaxAge  
priormatrix[32,] = c(3.54,1,4,1,1,24) #nAge
...
priormatrix[37,] = c(1,0.2,1.8,1,0,100) #fCg700 
priormatrix[38,] = c(0.65,0.01,1.8,1,0,29) #SWconst 
priormatrix[39,] = c(8,1.0,13,1,0,30)##SWpower
priormatrix[40,] = c(9.8e-4,2e-04,0.001666667,1,0,31)#mort_rate 
...
priormatrix[48,] = c(230,230,25,2,1,38) #Duke wSx1000 CAN ALSO BE Leaftover
...
priormatrix[60,] = c(5,0.001,100,1,0,100) #Ctrans_SD
...
priormatrix[71,] = c(0.1,0.0,1000,1,0,100)  #Ctrans_SD_2
